          ...
          <div className="card" key={player.jugador.id}>
            <div className="card-main">
              ...
              <div className="card-attributes">
                ...
                <div className="card-attribute">
                  <span className="card-attribute__value">{skillsPrincipales.toFixed(1) || '-'}</span>
                  <span className="card-attribute__name">Skills Principales</span>
                </div>
                <div className="card-attribute">
                  <span className="card-attribute__value">{skillsTacticas.toFixed(1) || '-'}</span>
                  <span className="card-attribute__name">Skills Tácticas</span>
                </div>
                <div className="card-attribute">
                  <span className="card-attribute__value">{skillsFisicas.toFixed(1) || '-'}</span>
              ...
              <div className="media-global">
                ...
                <span className="globalmedia-number">{player.jugador.Rating.toFixed(1)}</span>
              </div>
